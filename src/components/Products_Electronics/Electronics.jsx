...
export default function Electronics() {
  let [products] = Getapi("https://fakestoreapi.com/products/category/electronics")
  return (
    <>
      <div className='title'>
        <div className='details'>
          <h3>Electronics</h3>
          <p> <Link to='/Homepage'>Home</Link> > <a href='#'>Products</a> > <Link to='/Electronics'>Electronics</Link></p>
        </div>
      </div>
