...
export default function Accessories() {
  let [products] = Getapi("https://fakestoreapi.com/products/category/jewelery")
  return (
    <>
      <div className='title'>
        <div className='details'>
          <h3>Electronics</h3>
          <p> <Link to='/Homepage'>Home</Link> > <a href='#'>Products</a> > <Link to='/Accessories'>Accessories</Link></p>
        </div>
      </div>
