...
export default function Menclothing() {
  let [products] = Getapi("https://fakestoreapi.com/products/category/men's clothing")
  return (
    <>
      <div className='title'>
        <div className='details'>
          <h3>Electronics</h3>
          <p> <Link to='/Homepage'>Home</Link> > <a href='#'>Products</a> > <Link to='/Menclothing'>Men's Clothing</Link></p>
        </div>
      </div>
